  ...
  if (self.entityType ~= "npc") then
    ...
    helper.updateMessage("sync-ui", function(result)
      ...
      if (self.previousDialog ~= self.data.sextalk.currentDialog) then
        ...
        widget.setText("sexDialog.text", "^shadow;" .. self.data.sextalk.currentDialog)
      end
...
function updatePositionLabel()
  ...
  widget.setText("position.labelPosition", "^shadow;" .. name)
end
...
function updateSlot1Label()
  ...
  widget.setText("sextoySlot1.labelSlot1", "^shadow;" .. name)
end
