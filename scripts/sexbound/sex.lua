...
function sexState.enteringState(stateData)
  ...
  if sexPosition.animationState then 
    animator.setAnimationState("sex", sexPosition.animationState, true)
  else
...
function climaxState.enteringState(stateData)
  ...
  if sexPosition.climaxAnimationState then
...
function exitState.enteringState(stateData)
  ...
  if sexPosition.resetAnimationState then
    animator.setAnimationState("sex", sexPosition.resetAnimationState, true)
  else
    animator.setAnimationState("sex", sex.defaultStateAnimation("exitState"), true)
  end
end
